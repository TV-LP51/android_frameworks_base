 ...
 */
public class PAPieController extends EdgeGestureManager.EdgeGestureActivationListener implements OnTouchListener, OnClickListener{
    ...
    public static PAPieController getInstance() {
        if (mInstance == null) mInstance = new PAPieController();
        return mInstance;
    }
    ...
    public void populateMenu() {
        ...
        mLastApp = makeItem(R.drawable.ic_sysbar_lastapp_land, 1, LAST_APP_BUTTON, true);
