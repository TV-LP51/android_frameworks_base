...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock, mCenterClock, mCarrierLabel, mNetworkTraffic, mValidusLogo;
	...
	mValidusLogo = mView.findViewById(R.id.validus_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
		    ...
		    animateTransitionTo(mValidusLogo, newAlphaBC)
                    );
            if (isLightsOut(mode)) {
            ...
            mValidusLogo.setAlpha(newAlphaBC);
        }
    }
}
